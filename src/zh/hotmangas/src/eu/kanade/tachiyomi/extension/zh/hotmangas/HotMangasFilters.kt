...
open class HotMangaFilter(name: String, private val key: String, private val params: Array<Param>) :
...
class SearchFilter : HotMangaFilter("文本搜索范围", "q_type", SEARCH_FILTER_VALUES)
...
class GenreFilter(genres: Array<Param>) : HotMangaFilter("题材", "theme", genres)

class SortFilter : HotMangaFilter("排序", "ordering", SORT_VALUES)
